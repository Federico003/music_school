    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2><i class="material-icons">edit</i>Crea nuovo Insegnante</h2>
                    </div>
                    <div class="body">
                        ...
                        <form action="{{ route('admin.user.storeTeacher') }}" method="POST">
                            {{ csrf_field() }}
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <a href="{{ route('admin.teachers') }}" class="btn waves-effect btn-default ml-2">
