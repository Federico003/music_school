    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2><i class="material-icons">list</i>Elenco degli Insegnanti</h2>
                        <ul class="header-dropdown m-r--5">
                            <!-- Pulsanti per desktop -->
                            <button type="button" class="btn bg-deep-orange waves-effect"
                                    onclick="window.location.href='{{ route('admin.user.createTeacher') }}'">
        ...
        $(document).ready(function() {
            table = $('#users_table').DataTable({
                ...
                data: function(d) {
                    ...
                    d.role = 'teacher'; // Filtra solo gli insegnanti
                },
                },
                columns: [{
                        data: 'id'
